...
class ExpenseTrackerManager {
    ...
    func setDefaultCategories(){
            ...
            car.expensesArray.append(expense1)
            car.expensesArray.append(expense2)
            car.expensesArray.append(expense3)
            living.expensesArray.append(expense4)
            entertainment.expensesArray.append(expense5)
            others.expensesArray.append(expense6)
